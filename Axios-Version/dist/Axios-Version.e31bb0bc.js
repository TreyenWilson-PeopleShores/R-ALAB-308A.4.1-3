...
var API_KEY = "live_VOZbbd602q8H85w6A0laOJiAuJk7unXGEE8KYq3i9HNimRuFc7xzkIxA5sAOE71";
 ...
 */
var breedSelection = document.getElementById("breedSelect");
...
function _initialLoad() {
  _initialLoad = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var response, breeds, allBreeds, breed, _options;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          ...
          allBreeds = breeds; // This is so we don't have to call the API so many times
          //breeds
          for (breed = 0; breed < allBreeds.length; breed++) {
            _options = document.createElement("option");
            _options.textContent = allBreeds[breed].name;
            _options.value = allBreeds[breed].id;
            breedSelection.appendChild(_options);
          }
        case 2:
...
function initalImage() {
  return _initalImage.apply(this, arguments);
}
function _initalImage() {
  _initalImage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    var response, breeds, selectedBreed, responseImage, image, imageUrl;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        ...
        case 1:
          ...
          breeds = response.data; //let breeds = await response.json();
          selectedBreed = breeds[1];
          _context3.n = 2;
          return _axios.default.get("/images/".concat(selectedBreed.reference_image_id));
        case 2:
          responseImage = _context3.v;
          image = responseImage.data;
          imageUrl = image.url; //Carousel.createCarouselItem(selectedBreed.reference_image_id, selectedBreed.name, selectedBreed.id);
          Carousel.clear();
          Carousel.appendCarousel(Carousel.createCarouselItem(imageUrl, selectedBreed.name, selectedBreed.id));
          Carousel.start();
          document.getElementById("infoDump").innerHTML = "<h4> ".concat(selectedBreed.name, "</h4><p><b> Grooming:</b> ").concat(selectedBreed.grooming, "</p><p> <b>Temperament:</b> ").concat(selectedBreed.temperament, "</p><p> <b>Health Issues:</b> ").concat(selectedBreed.health_issues, "</p><p><b> Life Span: </b>").concat(selectedBreed.life_span, "</p>");
...
breedSelection.addEventListener("change", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  var selectedBreedId, response, breeds, selectedBreed, _iterator, _step, breed, responseImage, image, imageUrl, _t;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.p = _context.n) {
      case 0:
        selectedBreedId = breedSelection.value;
        _context.n = 1;
        return _axios.default.get("/breeds");
      case 1:
        response = _context.v;
        breeds = response.data;
        _iterator = _createForOfIteratorHelper(breeds);
        _context.p = 2;
        _iterator.s();
      case 3:
 ...
 */
function _favourite() {
  _favourite = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(imgId) {
...
//# sourceMappingURL=/Axios-Version.e31bb0bc.js.map